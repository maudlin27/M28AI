...
function ManageCombatUnitsInWaterZone(tWZData, tWZTeamData, iTeam, iPond, iWaterZone, tAvailableCombatUnits, tAvailableSubmarines, tUnavailableUnitsInThisWZ, tMissileShips)
    ...
    if M28Utilities.IsTableEmpty(tAvailableSubmarines) == false and M28Utilities.IsTableEmpty(EntityCategoryFilterDown(categories.TECH2 * categories.CYBRAN, tAvailableSubmarines)) == false and GetGameTimeSeconds() >= 15.5*60 then bDebugMessages = true end
