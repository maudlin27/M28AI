...
Tooltips = {
    aitype_m28ai = {
        title = "AI: M28",
        description = "Challenging adaptive AI designed for FAF, uses advanced micro coupled with strong macro",
    },
    aitype_m28aie = {
    ...
    aitype_m28aicheat = {
        title = "AIx: M28",
        description = "Cheating adaptive AI designed for FAF, uses advanced micro coupled with strong macro",
    },
    aitype_m28aiecheat = {
        title = "AIx: M28 Easy",
