...
function AddUnitToLandZoneForBrain(aiBrain, oUnit, iPlateau, iLandZone, bIsEnemyAirUnit)
    ...
    if oUnit.UnitId..M28UnitInfo.GetUnitLifetimeCount(oUnit) == 'ueb31019' then bDebugMessages = true end
