...
refCategoryAAGunship = categories.ANTIAIR * categories.MOBILE - refCategoryAirAA - categories.HIGHALTAIR - categories.BOMBER --to support blackops experimental air fortress (slow moving air experimental unit)
