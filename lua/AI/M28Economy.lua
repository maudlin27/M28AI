...
function UpgradeUnit(oUnitToUpgrade, bUpdateUpgradeTracker)
    ...
    if EntityCategoryContains(M28UnitInfo.refCategoryNavalFactory, oUnitToUpgrade.UnitId) then bDebugMessages = true M28Utilities.ErrorHandler('Audit trail', true, true) end
