...
function UpgradeUnit(oUnitToUpgrade, bUpdateUpgradeTracker)
    ...
    if EntityCategoryContains(M28UnitInfo.refCategoryLandFactory, oUnitToUpgrade.UnitId) then bDebugMessages = true M28Utilities.ErrorHandler('Audit trail', true, true) end
