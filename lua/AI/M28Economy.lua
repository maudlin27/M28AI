...
function UpgradeUnit(oUnitToUpgrade, bUpdateUpgradeTracker)
    ...
    if EntityCategoryContains(M28UnitInfo.refCategoryLandFactory * categories.TECH2, oUnitToUpgrade.UnitId) then bDebugMessages = true M28Utilities.ErrorHandler('Audit trail', true, true) bDebugMessages = false end
