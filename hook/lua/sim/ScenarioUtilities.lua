...
--if OrigInitializeSkirmishSystems then --safeGetGlobal('InitializeSkirmishSystems') then
    ...
    InitializeSkirmishSystems = function(self)
        ...
        if M28Utilities.bLoudModActive or M28Utilities.bQuietModActive then
            ...
            if (oBrain.BrainType == 'AI' and not(ArmyIsCivilian(oBrain:GetArmyIndex()))) or (oBrain.BrainType == 'Human' and  not(tonumber(ScenarioInfo.Options.M28CombinedArmy or 2) == 2) and not(ScenarioInfo.Options.M28CombinedArmy == 5)) then
